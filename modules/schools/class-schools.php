...
/**
 * Schools Module - Main Orchestrator
...
class OC_Schools_Module extends OC_Abstract_Module
{
    protected $public;
    protected $ajax;
    ...
    private function load_dependencies()
    {
        ...
        // Activator/Deactivator - Always loaded
        if (file_exists($module_path . 'activator.php')) {
            require_once $module_path . 'activator.php';
        }

        if (file_exists($module_path . 'deactivator.php')) {
            require_once $module_path . 'deactivator.php';
        }

        // Public components
        if (!is_admin()) {
            require_once $module_path . 'public/class-schools-public.php';
        }
    ...
    {
        $this->public = new OC_Schools_Public(
            $this->module_id,
            $this->version,
...
?>
        <div class="notice notice-error">
            <p><?php _e('Schools Module requires dependencies to be enabled.', 'organization-core'); ?></p>
        </div>
<?php
    }
}
